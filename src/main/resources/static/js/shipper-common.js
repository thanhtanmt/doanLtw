        ...
        if (data.success) {
            ...
            const content = `
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6">
                        <table class="table table-sm">
                            <tr><td><strong>Tạm tính</strong></td><td class="text-end">${formatCurrency(order.orderDetails.reduce((s,d)=> s + (d.totalPrice||0), 0))}</td></tr>
                            <tr><td>Giảm giá</td><td class="text-end">${formatCurrency(0)}</td></tr>
                            <tr><td>Phí vận chuyển</td><td class="text-end">${formatCurrency(0)}</td></tr>
                            <tr><td><strong>Tổng tiền</strong></td><td class="text-end"><strong>${formatCurrency(order.totalAmount)}</strong></td></tr>
                        </table>
                    </div>
                </div>
                ` : ''}
